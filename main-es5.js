...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /*! exports provided: default */
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentAddReferenceAddReferenceComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */
    var _component_add_reference_add_reference_component__WEBPACK_IMPORTED_MODULE_67__ = __webpack_require__( /*! ./component/add-reference/add-reference.component */"./src/app/component/add-reference/add-reference.component.ts");
    /* harmony import */
    var _component_header_header_service__WEBPACK_IMPORTED_MODULE_68__ = __webpack_require__( /*! ./component/header/header.service */"./src/app/component/header/header.service.ts");
    /* harmony import */
    var _assets_js_tour_service__WEBPACK_IMPORTED_MODULE_69__ = __webpack_require__( /*! ../assets/js/tour.service */"./src/assets/js/tour.service.ts");
    /* harmony import */
    var _superAdmin_super_admin_service__WEBPACK_IMPORTED_MODULE_70__ = __webpack_require__( /*! ./superAdmin/super-admin.service */"./src/app/superAdmin/super-admin.service.ts");
  ...
  function srcAppComponentAddDataAddDataComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AddDataComponent = /*#__PURE__*/function () {
      function AddDataComponent(dataService, router, route, fb, headerService) {
        var _this = this;
      ...
      _createClass(AddDataComponent, [{
        ...
        value: function addData() {
          ...
          switch (this.target) {
            case 'indicator':
              ...
              this.dataService.editIndicator(this.indicatorId, indicator).subscribe(function () {
        ...
        key: "learningActivitySelected",
        value: function learningActivitySelected(learningActivity) {
          var _this5 = this;
          if (learningActivity) {
            this.dataService.getEventsByActivityId(learningActivity._id).subscribe(function (events) {
              var eventNames = events.map(function (event) {
                return event.name;
              });
              if (eventNames.length === 1) {
                _this5.similarActivityMessage = "The selected learning activity \"".concat(learningActivity.name, "\"\n                    lies under the learning event \"").concat(eventNames[0], "\".");
              }
              if (eventNames.length > 1) {
                var namesWithComma = eventNames.join(', ');
                _this5.similarActivityMessage = "The selected learning activity \"".concat(learningActivity.name, "\" lies under\n                     the learning events \"").concat(namesWithComma, "\". Therefore, the Indicator and Metrics you want to add will\n                      be added automatically under all of the mentioned learning events.");
              }
            });
          } else {
  ...
  /*! exports provided: default */
  /***/
  function srcAppComponentAddReferenceAddReferenceComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentAddReferenceAddReferenceComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";

    __webpack_require__.r(__webpack_exports__);
    /* harmony export (binding) */
    __webpack_require__.d(__webpack_exports__, "AddReferenceComponent", function () {
    ...
    /* harmony import */
    var _header_header_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__( /*! ../header/header.service */"./src/app/component/header/header.service.ts");
    var AddReferenceComponent = /*#__PURE__*/function () {
      function AddReferenceComponent(dataService, router, fb, headerService, route) {
        var _this6 = this;
        _classCallCheck(this, AddReferenceComponent);
        this.dataService = dataService;
        this.router = router;
        this.fb = fb;
        this.route = route;
        ...
        if (this.referenceId) {
          this.dataService.getReferenceById(this.referenceId).subscribe(function (reference) {
            _this6.editableReference = reference;
            _this6.referenceNumber = reference.referenceNumber;
            _this6.referenceForm.patchValue({
              referenceText: reference.referenceText,
              referenceLink: reference.link,
              referenceNumber: reference.referenceNumber
            });
      ...
      _createClass(AddReferenceComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          if (!this.referenceId) {
        ...
        value: function addReference() {
          ...
          var referenceText = this.referenceForm.value.referenceText;
          var referenceLink = this.referenceForm.value.referenceLink;
          if (referenceLink === '') {
            referenceLink = null;
          }
          var reference = {
          ...
          if (this.referenceId) {
            this.dataService.updateReference(this.referenceId, reference).subscribe(function () {
              _this7.router.navigate(['/reference']);
            });
          } else {
        ...
        key: "fetchReferenceNumber",
        value: function fetchReferenceNumber() {
          var _this8 = this;
          this.dataService.getReferences().subscribe(function (references) {
            var referenceIds = references.map(function (reference) {
              return reference.referenceNumber;
            ...
            for (var i = 1; i <= referenceIds.length + 1; i++) {
              if (!referenceIds.includes("[".concat(i, "]"))) {
                _this8.referenceNumber = "[".concat(i, "]");
                _this8.referenceForm.patchValue({
                  'referenceNumber': _this8.referenceNumber
                });
                break;
              }
            }
    ...
    AddReferenceComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        value: function submit() {
          ...
          if (!this.register) {
            this.dataService.login(this.loginForm.value.username, this.loginForm.value.password).subscribe(function (res) {
              _this9.loginForm.reset();
              _this9.dataService.loggedIn = true;
              _this9.router.navigate([_this9.currentUrl], {
                state: {
                  additionalInfo: _this9.additionalInfo
                }
              });
            }, function (err) {
            ...
            this.dataService.register(this.loginForm.value).subscribe(function (added) {
              if (added) {
                ...
                window.alert("User could not be registered. User with username ".concat(_this9.loginForm.value.username, " already exists"));
                _this9.loginForm.reset();
              }
            });
          }
      ...
      _createClass(DisplayComponent, [{
        ...
        value: function fetchdata() {
          ...
          this.learningEventsOptions$ = this.dataService.getEvents().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(function (learningEvents) {
            ...
            _this10.allEventOptions = options;
            _this10.initFromLocalStorage(previousSelectedEvents, previousSelectedActivities, previousSelectedIndicators);
          }));
        }
      }, {
        ...
        value: function initFromLocalStorage(events, activities, indicators) {
          ...
          if (indicators) {
            indicators.forEach(function (indicator) {
              _this11.checkedMap.set(indicator._id, true);
              _this11.indicatorMap.set(indicator._id, indicator);
            });
        ...
        value: function onEventValueChange(eventValue) {
          ...
          setTimeout(function () {
            localStorage.setItem("selectedEventsInit", JSON.stringify(_this12.selectedLearningEvents));
          });
        }
      }, {
        key: "resetTable",
        ...
        value: function onActivitySelectChange() {
          ...
          setTimeout(function () {
            localStorage.setItem("selectedActivitiesInit", JSON.stringify(_this13.selectedLearningActivities));
          });
        }
      }, {
            ...
            Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(function (learningEvents) {
              return learningEvents.map(function (learningEvent) {
                learningEvent.activities = learningEvent.activities.filter(function (activity) {
                  return _this14.selectedLearningActivities.includes(activity.name);
                });
  ...
  function srcAppComponentDisplayTableTableComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var TableComponent = /*#__PURE__*/function () {
      ...
      _createClass(TableComponent, [{
        ...
        value: function deleteAsSuperAdmin(indic) {
          var _this18 = this;
          if (confirm("Do you really want to delete this Indicator?")) {
            this.indicatorDeleted.emit(indic);
            this.dataService.deleteIndicator(indic._id).subscribe(function () {
              _this18.updateValues.emit();
            });
          }
        }
      }, {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], TableComponent.prototype, "updateValues", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], TableComponent.prototype, "indicatorDeleted", void 0);
      ...
      _createClass(HeaderComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.headerTemplateService.headerSubject.subscribe(function (headerString) {
            _this19.currentPage = headerString;
          });
        }
      }, {
        key: "addIndicators",
    ...
    var ReferanceComponent = /*#__PURE__*/function () {
      function ReferanceComponent(dataService, router, headerService) {
        ...
        this.references$ = this.dataService.getReferences().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function (references) {
          return _this20.sortByRefNumber(references);
        }));
      ...
      _createClass(ReferanceComponent, [{
        ...
        value: function deleteAsSuperAdmin(reference) {
          ...
          if (confirm("Do you really want to delete this Reference?")) {
            this.dataService.deleteReference(reference).subscribe(function () {
              _this21.references$ = _this21.dataService.getReferences().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function (references) {
        ...
        value: function sortByRefNumber(references) {
          ...
          return references.sort(function (a, b) {
            var numberA = _this22.extractNumberFromRefNumber(a.referenceNumber);
            var numberB = _this22.extractNumberFromRefNumber(b.referenceNumber);
            if (numberA > numberB) {
              return 1;
            } else {
              return -1;
      ...
      _createClass(ReviewDisplayComponent, [{
        ...
        value: function getReviews() {
          ...
          this.dataService.getReviews(this.indicator._id).subscribe(function (reviews) {
            _this23.reviews = !_this23.loggedIn ? reviews : reviews.sort(function (e1, e2) {
              if (e1.name === _this23.loggedIn.username) {
                return -1;
              } else if (e2.name === _this23.loggedIn.username) {
                return 1;
              } else {
                return 0;
              }
            });
            if (_this23.loggedIn && _this23.reviews.length > 0 && _this23.reviews[0].name === _this23.loggedIn.username) {
              _this23.reviewExistsForUser = true;
              _this23.buttonLabel = 'Edit Review';
            } else {
              _this23.reviewExistsForUser = false;
              _this23.buttonLabel = 'Create Review';
            }
            _this23.calculateOverallAverage(reviews);
          });
        }
      }, {
    ...
    var ReviewEditComponent = /*#__PURE__*/function () {
      function ReviewEditComponent(dataService, router, route, headerService) {
        ...
        if (this.reviewId) {
          this.dataService.getReviewById(this.reviewId).subscribe(function (review) {
            _this25.review = review;
            _this25.dataService.getIndicatorById(review.indicatorId).subscribe(function (indicator) {
              _this25.indicator = indicator;
              _this25.dataService.getReferenceByReferenceNumber(indicator.referenceNumber).subscribe(function (reference) {
                _this25.reference = reference;
              });
            });
          });
        }
        ...
        if (this.indicatorId) {
          ...
          this.dataService.getReviewByIndicatorIdAndUsername(this.indicatorId, this.currentUser.username).subscribe(function (review) {
            console.log(review);
            if (review) {
              _this25.router.navigate(["review/".concat(review._id, "/edit")]);
            }
          });
        }
      }
      _createClass(ReviewEditComponent, [{
        ...
        value: function ngOnInit() {
          var _this26 = this;
          setTimeout(function () {
            _this26.formGroup.controls['name'].setValue(_this26.currentUser.username);
            if (_this26.review) {
              _this26.initializeForm(_this26.review);
            }
          }, 100);
        }
      }, {
  ...
  function srcAppDataServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DataService = /*#__PURE__*/function () {
      ...
      _createClass(DataService, [{
        ...
        key: "editIndicator",
        value: function editIndicator(id, indicator) {
          return this.http.put("".concat(this.uri, "/indicator/").concat(id, "/edit"), indicator);
        }
      }, {
        key: "deleteIndicator",
